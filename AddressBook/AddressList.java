...
public class AddressList {
        ...
        do {
            ...
            switch (response) {
                ...
                case 2:
                    ...
                    for (Entry ex : entryList) {


                        if (ex.getEmailAddress().equals(email)) {
                            addressList.remove(email);
                ...
                case 4:
                    for (Entry entry2 : entryList) {
                        System.out.println(" " + entry2);//+ "" + entry2.getFirstName() + "" + entry2.getLastName() + "" + entry2.getPhoneNumber() + "" + entry2.getEmailAddress());
                    }
                    break;
                case 5:
    ...
    public Entry search(String name) {
        ...
        for (Entry e : entryList) {
            if (e.getFirstName().equals(name) || e.getLastName().equals(name) || e.getPhoneNumber().equals(name) || e.getEmailAddress().equals(name))
                en = e;
